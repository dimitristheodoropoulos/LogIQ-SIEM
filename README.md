...
## ISO 27001 Συμμόρφωση (Compliance Evidence)

Το LogIQ υλοποιεί βασικούς ελέγχους από το Παράρτημα Α του προτύπου ISO/IEC 27001:2022, αποδεικνύοντας δυνατότητα δημιουργίας verifiable evidence για ελέγχους ασφαλείας:

- **A.8.15 Καταγραφή (Logging)** – Κεντρική συλλογή και αποθήκευση logs ασφαλείας (Linux/Windows authentication) με ελεγχόμενη ακεραιότητα.
- **A.8.16 Παρακολούθηση Δραστηριοτήτων (Monitoring)** – Έγκαιρη ανίχνευση brute‑force επιθέσεων και μη φυσιολογικών ωρών σύνδεσης με ειδοποιήσεις μέσω REST API και CLI.
- **A.8.8 Διαχείριση Τεχνικών Τρωτών Σημείων (Vulnerability Management)** – Ενσωμάτωση με OpenVAS για αυτοματοποιημένη σάρωση ευπαθειών και παραγωγή αναφορών.
- **A.5.23 Ασφάλεια Πληροφοριών για Χρήση Υπηρεσιών Νέφους (Cloud)** – Το σύστημα είναι container‑ready (Docker), υποστηρίζει διαχείριση μυστικών (JWT, rate limiting) και μπορεί να εκτελεστεί σε cloud infrastructure με κατάλληλες πολιτικές ασφαλείας.
