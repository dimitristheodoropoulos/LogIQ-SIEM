...
# FIX: Import from log_collector_linux
from log_collector_linux import get_auth_token, send_events, read_auth_log 
...
def test_read_auth_log_file_not_found(caplog_setup):
    ...
    with patch('parsers.auth_parser.parse_auth_log', return_value=[]):
